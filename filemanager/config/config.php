...
/**
 * a way to get relative paths/urls without domain cleanly - JF
 */
$dropkick_cms_app_base_source = $_SERVER["REQUEST_URI"];
$dropkick_cms_app_base_source = explode('/filemanager/', $dropkick_cms_app_base_source );
$dropkick_cms_app_base_source = $dropkick_cms_app_base_source[0];
...
$config = array(
	...
	*/
	#'upload_dir' => '/source/',
	#'upload_dir' => ($dropkick_cms_app_base_source . '/cms/img/user_files/source/'),
	#'upload_dir' => (__DIR__ . '/../../cms/img/user_files/source/'),
	#'upload_dir' => ('/cms/img/user_files/source/'),
	'upload_dir' => ('/filemanager/cms/img/user_files/source/'),
	...
	*/
	#'current_path' => '../source/',
	#'current_path' => '../cms/img/user_files/source/',
	#'current_path' => (__DIR__ . '/../../cms/img/user_files/source/'),
	'current_path' => ('cms/img/user_files/source/'),
	...
	*/
	...
	#'thumbs_base_path' => '../cms/img/user_files/thumbs/',
	#'thumbs_base_path' => (__DIR__ . '/../../cms/img/user_files/thumbs/'),
	'thumbs_base_path' => ('../cms/img/user_files/thumbs/'),
	...
	*/
	...
	'access_keys' => array('QFRKKN3tZL2fFStM'),
