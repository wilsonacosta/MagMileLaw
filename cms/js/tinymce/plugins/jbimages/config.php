...
| -------------------------------------------------------------------*/
	...
	#$config['img_path'] = '/cms/img/user_img'; // Relative to domain name
	#$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	
	$config['img_path'] = $_SERVER["REQUEST_URI"];
	$config['img_path'] = explode('/cms/js/tinymce/plugins/jbimages/', $config['img_path'] );
	$config['img_path'] = $config['img_path'][0] . '/cms/img/user_img'; # Relative to /js/tinymce/plugins/jbimages/ in the URI
	
	$config['upload_path'] = realpath(__DIR__ . '/../../../../../cms/img/user_img'); # Physical path. Relative to the current directory THIS script is in
